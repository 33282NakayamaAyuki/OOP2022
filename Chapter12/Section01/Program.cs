...
namespace Section01 {
    class Program {
        ...
        public static void Serialize()
        {
            ...
            using (var writer = XmlWriter.Create("novels.xml",settings))//settingsなしでもOK
            {
        ...
        public static void Deserialize()
        {
            ...
            {
                var serializer = new DataContractSerializer(typeof(Novel[])); //p185
                var novels = serializer.ReadObject(reader) as Novel[];//as Novel キャストしている
